...
let isGamePanelOpening = false; // AJOUTÉ
...
// Remplacé : nouvelle version de renderGamePanel
...
async function showGamePanel(categoryKey) {
    ...
    try {
        ...
        isGamePanelOpening = false;           // ← AJOUTÉ
    }
}
...
// REMPLACÉ : nouvelle version de startTimer
function startTimer() {
    if (timerInterval) {
        clearInterval(timerInterval);
        timerInterval = null;
    }
    if (!currentGame || !currentGame.gameActive) return;  // ← AJOUTÉ
    renderTimer();
