(function() {
  ...
  function renderState(snapshot) {
    ...
    // CORRECTION : si le snapshot n'a pas de gameCode (reçu via socket sans métadonnées),
    // on garde celui de la partie en cours pour ne pas abandonner la mise à jour.
