-- Evite les deadlocks quand plusieurs joueurs quittent la meme salle en meme temps.
...
begin
  ...
  perform pg_advisory_xact_lock(hashtextextended('multiplayer_leave:' || v_code, 0));
