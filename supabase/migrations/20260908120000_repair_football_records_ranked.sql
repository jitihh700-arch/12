-- Réparation de la catégorie Football Records pour le mode classé.
-- Cette migration est idempotente : elle réactive la catégorie et garantit
-- que les 10 réponses utilisées par le RPC de quiz sont présentes.
...
-- Sécurité : aucune réponse obsolète ne doit rester en dehors des 10 positions
-- attendues pour cette catégorie.
delete from private.quiz_answers
where category_id = 'footballRecords'
  and display_order not between 1 and 10;
